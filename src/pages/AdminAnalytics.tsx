      ...
      <div className="mb-16 text-center lg:text-left flex flex-col lg:flex-row justify-between items-center gap-8">
        <div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 leading-none mb-4 tracking-tighter uppercase">
            Business <span className="text-orange-600 underline decoration-4 md:decoration-8 decoration-orange-200 underline-offset-4 md:underline-offset-8">Intelligence</span>
          </h1>
